...
```{r, dependson="load"}
h <- ggplot(full_df, aes(x=log(rain), y=log(tss_sum+0.000359), color=Treatment), inherit.aes = FALSE) +
...
#ggsave("E:/ISU/Project/SoilMove/data/statistics/flume_analysis/code/fig/Reg_ppt_loadOUT.png", h, width = 12, height = 12)
...
m_flume <- lmerTest::lmer(log(tss_sum+0.000359) ~ 
                             Treatment*ln_ppt +
                            #Treatment*crop +
                            Year*Treatment +
