...
trtyrR_grp <- flumeR %>% 
 ...
 ggsave("E:/ISU/Project/SoilMove/data/statistics/flume_analysis/code/fig/randflumeyr_plot.png", trtR_plot)
...
add <- data.frame(variable = c("ln_S", "ln_L", "ln_LS", "slope75", "ln_postL", "ln_postT"))
